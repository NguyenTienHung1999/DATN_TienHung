				...
				<div class="row">
					<div class="col-sm-12">
								...
								<div class="col-sm-3">
									...
									<div class="single-item">
										...
										<div class="single-item-body">
											<p class="single-item-title" style="height: 40px">{{$new->name}}</p>
						...
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">{{count($sanpham_khuyenmai)}} sản phẩm</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
								...
								<div class="col-sm-3">
									...
									<div class="single-item">
										...
										<div class="single-item-body">
											<p class="single-item-title" style="height: 40px">{{$spkm->name}}</p>
											<p class="single-item-price" style="font-size: 16px;height: 30px">
												@if($spkm->promotion_price==0)
