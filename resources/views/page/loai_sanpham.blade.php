		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{route('trang-chu')}}">Home</a> / <span>{{$loai_sp->name}}</span>
				</div>
			</div>
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-body">
											<p class="single-item-title" style="height: 40px">{{$sp->name}}</p>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									...
									<div class="single-item">
										...
										<div class="single-item-body">
											<p class="single-item-title" style="height: 40px">{{$spk->name}}</p>
											<p class="single-item-price" style="font-size: 16px;height: 30px">
												@if($spk->promotion_price==0)
